...
from typing import Dict, Final, Generic
...
class PreJsPy:
    ...
    def setConstants(self, d: dict[str, L]): ...
    def getUnaryOperators(self) -> list[U]: ...
    def setUnaryOperators(self, ary: list[U]): ...
    def getBinaryOperators(self) -> dict[B, int]: ...
    def setBinaryOperators(self, d: dict[B, int]): ...
    def getTertiaryOperatorEnabled(self) -> bool: ...
    def setTertiaryOperatorEnabled(self, e: bool): ...
    def getIdentifiersEnabled(self) -> bool: ...
    def setIdentifiersEnabled(self, e: bool): ...
